...
// // Получить один товар по id (для страницы деталей)
// export const selectProductById = (state, id) =>
// state.products.items.find((p) => p.id === id);

// // Проверить, откуда пришли данные (например, из категории)
// export const isFromCategory = (state, categoryId) =>
// state.products.source === `category:${categoryId}`;
...
// status: "idle", // "idle" | "loading" | "succeeded" | "failed"
// error: null,
// source: null, // "all" | "sales" | `category:${id}` | `id:${id}`
// },
// reducers: {
// clearProducts(state) {
// state.items = [];
...
// .addCase(thunk.fulfilled, (s, a) => {
// s.status = "succeeded";
// // Если это запрос одного продукта — оборачиваем в массив
